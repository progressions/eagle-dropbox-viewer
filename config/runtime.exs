...
#
#     PHX_SERVER=true bin/eagle_dropbox_viewer start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :eagle_dropbox_viewer, EagleDropboxViewerWeb.Endpoint, server: true
end
  ...
  config :eagle_dropbox_viewer, EagleDropboxViewerWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"lib/eagle_dropbox_viewer_web/router\.ex$"E,
        ~r"lib/eagle_dropbox_viewer_web/(controllers|live|components)/.*\.(ex|heex)$"E
      ]
    ]
end
...
if config_env() == :prod do
  ...
  config :eagle_dropbox_viewer, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :eagle_dropbox_viewer, EagleDropboxViewer.Mailer,
