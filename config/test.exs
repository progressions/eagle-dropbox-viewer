...
config :eagle_dropbox_viewer, EagleDropboxViewerWeb.Endpoint,
  ...
  secret_key_base: "XmA4x1s/KRlPeOHz73NUQmre0+ruCLy5PRz2HVZYdikv/cd0PLTxif+jYwm2YXza",
  server: false

# In test we don't send emails
config :eagle_dropbox_viewer, EagleDropboxViewer.Mailer, adapter: Swoosh.Adapters.Test
